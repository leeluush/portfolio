...
function Footer() {
  ...
  return (
    ...
    >
      ...
      >
        <Typography className="logo" sx={{ fontFamily: 'Caveat, cursive' }}>
          Lee Pozmantir Confino
        </Typography>
        <Box component="div" className="footer--items">
        ...
        <Box component="div" className="footer--social--icon">
          <ul style={{ display: 'flex', padding: 0, listStyleType: 'none' }}>
      ...
      <Box component="div" className="footer--content--container">
        <Typography className="footer--content" sx={{ fontFamily: 'Caveat, cursive' }}>
          © 2024 Lee Pozmantir Confino. All rights reserved.
        </Typography>
      </Box>
    </Box>
  );
